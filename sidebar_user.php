...
<aside id="sidebar" class="sidebar-gradient text-white w-64 flex-shrink-0 fixed md:static h-full z-40 transform -translate-x-full md:translate-x-0 transition-all duration-300 ease-in-out flex flex-col">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <a href="user_history.php" class="sidebar-item flex items-center px-4 py-3 transition-all duration-200 rounded-xl <?= ($current_page == 'user_history.php') ? 'active' : '' ?>">
            <i class="sidebar-icon bi bi-clock-history mr-3 text-lg"></i> 
            <span class="sidebar-text font-medium">ประวัติการยืม</span>
        </a>
        
        <a href="borrowing_dashboard.php" class="sidebar-item flex items-center px-4 py-3 transition-all duration-200 rounded-xl <?= ($current_page == 'borrowing_dashboard.php') ? 'active' : '' ?>">
